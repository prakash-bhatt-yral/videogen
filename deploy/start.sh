...
export VIDEOGEN_STATE_DB_PATH="${VIDEOGEN_STATE_DB_PATH:-/workspace/videogen-worker/state.db}"
export PRAKASH_COMPLETION_HMAC_KEY_ID="${PRAKASH_COMPLETION_HMAC_KEY_ID:-}"
export PRAKASH_COMPLETION_HMAC_SECRET_B64="${PRAKASH_COMPLETION_HMAC_SECRET_B64:-}"
